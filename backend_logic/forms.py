...
class MultiStepBursaryApplicationForm(forms.Form):
    ...
    bothParentsAlive = forms.ChoiceField(choices=[(True, 'Yes'), (False, 'No')], widget=forms.RadioSelect, label="Are both parents alive?")
    singleParent = forms.ChoiceField(choices=[(True, 'Yes'), (False, 'No')], widget=forms.RadioSelect, label="Are you from a single parent family?")
